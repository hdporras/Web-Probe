...
public class WPJustificationPMLNode
{
	/** Contains Infrence Steps of the PML Node */
	public ArrayList<WebProbeInferenceStep> inferenceSteps;

	
	public WPJustificationPMLNode(IWNodeSetOccur ns)
	{
		inferenceSteps = new ArrayList<WebProbeInferenceStep>();
		//IWNodeSetOccur ns = IWPMLObjectManager.getProofOccurrence(URI);
		
		inferenceSteps = getNodeSetInferenceSteps(ns);
	}
